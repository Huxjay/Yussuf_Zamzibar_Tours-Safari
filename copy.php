on admin.php we have this part which is over view part 

so we want those to be real one from the daata base if there is other overview required you can add them 


the data are from these three 3 tables 
...
words does not well seen can we adjust this one (only css to fix that one)